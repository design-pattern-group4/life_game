...
public class MapSizeTest {
    ...
    public void EqualSingletonInstanceTest(){
        ...
        //given
        GridCellsize a = GridCellsize.getInstance();
        GridCellsize b = GridCellsize.getInstance();
        ...
        assertEquals(a.getGridSize(),b.getGridSize());
        System.out.println("a gridSize : "+ a.getGridSize());
        System.out.println("b gridSize : "+b.getGridSize());
    ...
    public void changeMapSizeTest(){
        ...
        System.out.println("2*2: "+ totalCell);
        ...
        System.out.println("4*4: "+ totalCell);
        //then
        ...
        outermostCell.changeMap2();
        totalCell = outermostCell.widthInCells() * gridCellsize.getCellSize() * gridCellsize.getGridSize();
        System.out.println("8*8: "+ totalCell);
        //then
